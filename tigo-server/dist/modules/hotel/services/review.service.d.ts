...
export declare class ReviewService {
    ...
    constructor(reviewRepository: Repository<HotelReview>, hotelRepository: Repository<Hotel>, bookingRepository: Repository<HotelBooking>, userRepository: Repository<User>, dataSource: DataSource, hotelDataSyncService: HotelDataSyncService);
