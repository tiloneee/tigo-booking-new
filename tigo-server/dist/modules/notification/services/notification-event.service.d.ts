...
export declare class NotificationEventService implements OnModuleInit {
    ...
    triggerBookingNotification(userId: string, type: 'BOOKING_CONFIRMATION' | 'BOOKING_CANCELLED' | 'BOOKING_REMINDER' | 'BOOKING_CREATED', title: string, message: string, metadata: any): Promise<void>;
