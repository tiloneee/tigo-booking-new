...
export declare class ChatService {
    ...
    constructor(chatRoomRepository: Repository<ChatRoom>, chatMessageRepository: Repository<ChatMessage>, userService: UserService, redisService: RedisService);
