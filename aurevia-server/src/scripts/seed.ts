...
async function bootstrap() {
  ...
  const permissions = [
    ...
    {
      name: 'manage_rooms',
      description: 'Full room management (add, update, delete)',
    },
    {
      name: 'manage_room_pricing',
      description: 'Manage room pricing and availability',
    },
    ...
    { name: 'view_own_bookings', description: 'View own booking history' },
    {
      ...
      description: 'View bookings for owned hotels',
    },
    {
      name: 'view_all_bookings',
      description: 'View all platform bookings (admin)',
    },
    {
      name: 'manage_booking_status',
      description: 'Update booking status and payments',
    },
    ...
    { name: 'search_hotels', description: 'Search and browse hotels' },
    {
      ...
      description: 'View public hotel information',
    },
    ...
    { name: 'view_reviews', description: 'View reviews and ratings' },
    {
      ...
      description: 'Moderate and manage reviews (admin)',
    },

    // === AMENITIES MANAGEMENT ===
    {
      name: 'manage_amenities',
      description: 'Manage global amenities catalog',
    },
  ];
